...
def process_and_plot_wav(wav_file_path, plot_path, plot_type):
    ...
    if (plot_type == 'mag'):
        ...
        ax = pf.plot.time(transfer_function)
        ax.set_xlim([0.0, 0.0026])
...
measurement_paths = []
measurement_paths.append("Python\Measurements\Dirac Juce HRIR Sample Points")

plots_paths = []
plots_paths.append("Python\Plots\Dirac Juce HRIR Sample Points")
