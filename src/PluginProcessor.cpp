...
PluginProcessor::PluginProcessor() : 
    ...
    */
    apvts(*this, nullptr, "positionParams", {
        ...
        std::make_unique<AudioParameterFloat>("specGain", "Specular Sound Gain", juce::NormalisableRange<float>(-60.f, 0.f), 0.f),
        std::make_unique<AudioParameterFloat>("diffGain", "Diffuse Sound Gain", juce::NormalisableRange<float>(-60.f, 0.f), 0.f)
     })
{
...
{   
    ...
    for (auto it = delayProcessors.begin(); it != delayProcessors.end(); ++it)
    {
        ...
        // initialize Diffuse Field Processor Gain
        // To-Do
    }
