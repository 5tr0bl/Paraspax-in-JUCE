...
{   
    ...
    //Vector3D<float> translation(*listenerPositionInit - *listenerPositionCurrent);
    ...
    for (auto it = delayProcessors.begin(); it != delayProcessors.end(); ++it)
    {
        ...
        //CoordHelpers::sphericalBnf2cartesian(dp.getAzimuth(), dp.getElevation(), dp.getCurrentDistance(), x, y, z);
