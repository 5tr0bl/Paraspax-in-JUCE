...
void PluginProcessor::oscMessageReceived(const OSCMessage& message)
{
    ...
    else if (message.getAddressPattern().toString().compare("x_lis"))
    {
    ...
    else if (message.getAddressPattern().toString().compare("y_lis"))
    {
    ...
    else if (message.getAddressPattern().toString().compare("z_lis"))
    {
