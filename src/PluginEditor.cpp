...
PluginEditor::PluginEditor (PluginProcessor* ownerFilter)
    : AudioProcessorEditor(ownerFilter), progressbar(progress), fileChooser ("File", File(), true, false, false,
                                                                             "*.sofa;*.nc;", String(),
                                                                             "Load SOFA File"),
                                                                valuetreestate(ownerFilter->apvts)
{
    ...
    /* Paraspax DFP toggle */
    TB_enableDFP.reset(new juce::ToggleButton("new toggle button"));
    addAndMakeVisible(TB_enableDFP.get());
    TB_enableDFP->setButtonText(TRANS("DFP"));
    TB_enableDFP->setToggleState(true, juce::NotificationType::dontSendNotification);
    TB_enableDFP->addListener(this);
    TB_enableDFP->setColour(juce::TextButton::buttonColourId, juce::Colour(250, 0, 0)); //juce::Colour(0xff14889e)); 
    TB_enableDFP->setBounds(23, 40, 54, 14);
    ...
    TBenablePreProc->setToggleState(false, juce::NotificationType::dontSendNotification);
    TBenablePreProc->addListener (this);
    TBenablePreProc->setEnabled(false); // DF Pre-processing not wanted here
    ...
    setSize (920, 562); // size of whole GUI, original height = 362
    ...
    xyPad.setBounds(0, 362, 200, 200);

    // XY Pad Sliders for source and listener position
    // The order of slider registration is important here because of slider indexing in XyPad.cpp
    // first listener, then source
    lisPosXslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(lisPosXslider.get());
    lisPosXslider->setRange(0, 20, 0.01);
    lisPosXslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    lisPosXslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    lisPosXslider->setBounds(200, 385, 70, 70);
    lisPosXsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "lisPosX", *lisPosXslider));
    lisPosXsliderLabel.attachToComponent(lisPosXslider.get(), false);
    xyPad.registerSlider(lisPosXslider.get(), XyPad::Axis::X);

    lisPosYslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(lisPosYslider.get());
    lisPosYslider->setRange(0, 20, 0.01);
    lisPosYslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    lisPosYslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    lisPosYslider->setBounds(270, 385, 70, 70);
    lisPosYsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "lisPosY", *lisPosYslider));
    lisPosYsliderLabel.attachToComponent(lisPosYslider.get(), false);
    xyPad.registerSlider(lisPosYslider.get(), XyPad::Axis::Y);

    lisPosZslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(lisPosZslider.get());
    lisPosZslider->setRange(0.f, 3.f, 0.01);
    lisPosZslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    lisPosZslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    lisPosZslider->setBounds(340, 385, 70, 70);
    lisPosZsliderLabel.attachToComponent(lisPosZslider.get(), false);
    lisPosZsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "lisPosZ", *lisPosZslider));

    srcPosXslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(srcPosXslider.get());
    srcPosXslider->setRange(0, 20, 0.01);
    srcPosXslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    srcPosXslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    srcPosXslider->setBounds(200, 485, 70, 70);
    srcPosXsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "srcPosX", *srcPosXslider));
    srcPosXsliderLabel.attachToComponent(srcPosXslider.get(), false);
    xyPad.registerSlider(srcPosXslider.get(), XyPad::Axis::X);

    srcPosYslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(srcPosYslider.get());
    srcPosYslider->setRange(0, 20, 0.01);
    srcPosYslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    srcPosYslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    srcPosYslider->setBounds(270, 485, 70, 70);
    srcPosYsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "srcPosY", *srcPosYslider));
    srcPosYsliderLabel.attachToComponent(srcPosYslider.get(), false);
    xyPad.registerSlider(srcPosYslider.get(), XyPad::Axis::Y);

    srcPosZslider.reset(new TwoPointDecimalSlider(false));
    addAndMakeVisible(srcPosZslider.get());
    srcPosZslider->setRange(0.f, 3.f, 0.01);
    srcPosZslider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    srcPosZslider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    srcPosZslider->setBounds(340, 485, 70, 70);
    srcPosZsliderLabel.attachToComponent(srcPosZslider.get(), false);
    srcPosZsliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "srcPosZ", *srcPosZslider));

    // Specular/Diffuse Gain Sliders
    specularGainSlider.reset(new TwoPointDecimalSlider(true));
    addAndMakeVisible(specularGainSlider.get());
    specularGainSlider->setRange(-60.f, 6.f, 0.01);
    specularGainSlider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    specularGainSlider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    specularGainSlider->setBounds(470, 485, 70, 70);
    specularGainSliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "specGain", *specularGainSlider));
    specularGainSliderLabel.attachToComponent(specularGainSlider.get(), false);

    diffuseGainSlider.reset(new TwoPointDecimalSlider(true));
    addAndMakeVisible(diffuseGainSlider.get());
    diffuseGainSlider->setRange(-60.f, 6.f, 0.01);
    diffuseGainSlider->setSliderStyle(juce::Slider::RotaryHorizontalVerticalDrag);
    diffuseGainSlider->setTextBoxStyle(juce::Slider::TextBoxBelow, false, 58, 15);
    diffuseGainSlider->setBounds(540, 485, 70, 70);
    diffuseGainSliderAttachment.reset(new juce::AudioProcessorValueTreeState::SliderAttachment(valuetreestate, "diffGain", *diffuseGainSlider));
    diffuseGainSliderLabel.attachToComponent(diffuseGainSlider.get(), false);
    ...
    sourceCoordsView_handle = new inputCoordsView(ownerFilter, NUM_DELAY_PROCESSORS, NUM_DELAY_PROCESSORS);
    ...
    sourceCoordsVP->setBounds(10, 153, 190, 180);
    ...
    TB_enableDFP->setTooltip("Enables/Disables Diffuse Field Processor.");
...
PluginEditor::~PluginEditor()
{
    ...
    xyPad.deregisterSlider(lisPosXslider.get());
    xyPad.deregisterSlider(lisPosYslider.get());
    xyPad.deregisterSlider(srcPosXslider.get());
    xyPad.deregisterSlider(srcPosYslider.get());

    lisPosXsliderAttachment = nullptr;
    lisPosYsliderAttachment = nullptr;
    lisPosZsliderAttachment = nullptr;
    srcPosXsliderAttachment = nullptr;
    srcPosYsliderAttachment = nullptr;
    srcPosZsliderAttachment = nullptr;
    specularGainSliderAttachment = nullptr;
    diffuseGainSliderAttachment = nullptr;

    lisPosXslider = nullptr;
    lisPosYslider = nullptr;
    lisPosZslider = nullptr;
    srcPosXslider = nullptr;
    srcPosYslider = nullptr;
    srcPosZslider = nullptr;
    specularGainSlider = nullptr;
    diffuseGainSlider = nullptr;
...
void PluginEditor::paint (juce::Graphics& g)
{
    ...
    // lower half dark background
    {
        int x = 0, y = 193, width = 920, height = 367;
        juce::Colour fillColour1 = juce::Colour (0xff19313f), fillColour2 = juce::Colour (0xff041518);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (juce::ColourGradient (fillColour1,
    ...
    {
        // container around inputCoordsView
        int x = 0, y = 121, width = 208, height = 232; 
        juce::Colour fillColour = juce::Colour (0x10f4f4f4);
        juce::Colour strokeColour = juce::Colour (0x67a0a0a0);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
...

    {
        ...
        juce::String text (TRANS("Paraspax |"));
        juce::Colour fillColour = juce::Colours::white;
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
    ...
    {
        int x = 116, y = 1, width = 50, height = 32;
        juce::String text (TRANS("VAE"));
    ...
    {
        int x = 166, y = 1, width = 100, height = 32;
        juce::String text (TRANS("6 DoF"));
...
void PluginEditor::buttonClicked (juce::Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == TB_enableDFP.get())
    {
        // toggle DFP
        hVst->dfpEnabled = !(hVst->dfpEnabled);
    }
...
{
    if (&editor == te_oscport.get())
    {
        // Handle the change in the OSC port editor
        juce::String newPortValue = editor.getText();
        int newPortValueInt = newPortValue.getIntValue();
        if (newPortValueInt > 0) {
            DBG("OSC Port changed to: " + newPortValue);
            hVst->setOscPortID(newPortValueInt);
        }
    }
}
...
void PluginEditor::timerCallback(int timerID)
{
    switch(timerID){
        ...
        case TIMER_GUI_RELATED:
            ...
            // (Micha) listen to xyPad-related parameter changes in the PluginProcessor (after psx loading)
            if (hVst->updateRoomDims) {
                // pass on to xy pad and update slider ranges
                // think about slider intervals !!!
                xyPad.setRoomDimensions(*hVst->roomDims);
                lisPosZslider->setRange(0, xyPad.roomDims->z);
                srcPosZslider->setRange(0, xyPad.roomDims->z);
                hVst->updateRoomDims = false;
            }
            if (hVst->updateXyPadPosition) {
                // check if the init positions are nullptrs

                xyPad.setThumbPosition("source", *hVst->sourcePositionInit);
                xyPad.setThumbPosition("receiver", *hVst->listenerPositionInit);
                // set z-coords for the two z-sliders
                lisPosZslider->setValue(hVst->listenerPositionInit->z);
                srcPosZslider->setValue(hVst->sourcePositionInit->z);
                // reset the update flag
                hVst->updateXyPadPosition = false;
            }

            // check if slider values have changed and then 
            // adjust listener position in PluginProcessor
            /*
            if (fabsf(lisPosXslider->getValue() - hVst->listenerPositionCurrent->x) > 1e-2f) {
                ...
                //lisPosXslider->setValue(hVst->listenerPositionCurrent->x);
            ...
            if (fabsf(lisPosYslider->getValue() - hVst->listenerPositionCurrent->y) > 1e-2f) {
                ...
                //lisPosYslider->setValue(hVst->listenerPositionCurrent->y);
                //hVst->updateDelayProcessorParams = true;
            }
            if (fabsf(lisPosZslider->getValue() - hVst->listenerPositionCurrent->z) > 1e-2f) {
                ...
                //lisPosZslider->setValue(hVst->listenerPositionCurrent->z);
                //hVst->updateDelayProcessorParams = true;
            }
            */
            ...
            if(binauraliser_getCodecStatus(hBin)==CODEC_STATUS_INITIALISING){
                ...
                if(TB_enableDFP->isEnabled())
                    TB_enableDFP->setEnabled(false);
