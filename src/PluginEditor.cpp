                                                                ...
                                                                valuetreestate(ownerFilter->apvts)
{
    ...
    // The order of slider registration is important here, first listener, then source
    lisPosXslider.reset(new juce::Slider());
    ...
    lisPosXslider->setBounds(200, 362, 70, 70);
    //lisPosXslider->addListener(this);
    ...
    lisPosYslider.reset(new juce::Slider());
    ...
    lisPosYslider->setBounds(200, 432, 70, 70);
    //lisPosYslider->addListener(this);
    ...
    lisPosZslider.reset(new juce::Slider());
    ...
    lisPosZslider->setBounds(200, 502, 60, 60);
    //lisPosZslider->addListener(this);
    ...
    srcPosXslider.reset(new juce::Slider());
    ...
    srcPosXslider->setBounds(270, 362, 70, 70);
    ...
    srcPosYslider.reset(new juce::Slider());
    ...
    srcPosYslider->setBounds(270, 432, 70, 70);
    ...
    srcPosZslider.reset(new juce::Slider());
    ...
    srcPosZslider->setBounds(270, 502, 60, 60);
